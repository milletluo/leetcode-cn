## [904. 水果成篮(中等)](https://leetcode-cn.com/problems/fruit-into-baskets/)
<div class="notranslate"><p>在一排树中，第 <code>i</code> 棵树产生&nbsp;<code>tree[i]</code> 型的水果。<br>
    ...
    public int totalFruit(int[] tree) {
        ...
        while (right < tree.length) {
            if (map.containsKey(tree[right])) {
                ...
                while (map.size() == 2) {
                    int leftSize = map.get(tree[left]);
                    if (leftSize > 1) {
