## [1500. 设计文件分享系统(中等)](https://leetcode-cn.com/problems/design-a-file-sharing-system/)
<div class="notranslate"><p>我们需要使用一套文件分享系统来分享一个非常大的文件，该文件由&nbsp;<code>m</code> 个从&nbsp;<code>1</code>&nbsp;到&nbsp;<code>m</code>&nbsp;编号的文件块组成。</p>
...
class FileSharing {
    int capacity;
    TreeMap<Integer, Set<Integer>> userMap;
    ...
    public int join(List<Integer> ownedChunks) {
        for (int i = 1; i < Integer.MAX_VALUE; i++) {
            if (!userMap.containsKey(i)) {
                userMap.put(i, new HashSet<>(ownedChunks));
                return i;
            }
        }
        return 0;
