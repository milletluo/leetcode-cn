## [1400. 构造 K 个回文字符串(中等)](https://leetcode-cn.com/problems/construct-k-palindrome-strings/)
<div class="notranslate"><p>给你一个字符串 <code>s</code>&nbsp;和一个整数 <code>k</code>&nbsp;。请你用 <code>s</code>&nbsp;字符串中 <strong>所有字符</strong>&nbsp;构造 <code>k</code>&nbsp;个非空 <strong>回文串</strong>&nbsp;。</p>
...
## 思路
奇数次的字母, 要组成回文串, 必须单独形成，因此奇数次的个数要小于k
